...
**Related (separate topic):** **[Edge AI](../5.%20Edge%20AI%20and%20Model%20Optimization/Guide.md)** — where models run on-device, latency/privacy tiers, train → optimize → deploy.
